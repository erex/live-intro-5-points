...
date: Exercise 5. Point transect sampling <br> September 2020
output: 
...
In the code provided below, each data set is loaded and detection functions selected by Prof Buckland in his paper are fitted. 
